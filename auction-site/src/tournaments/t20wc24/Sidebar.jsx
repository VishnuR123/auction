...
import myicon from "./assets/t20-logo.svg?url";
import { T20WC24_BASE } from "./t20wc24Paths.js";

/** Inline SVGs — no @mui/icons-material (not in auction-site deps). */
      ...
      <nav>
        ...
        <ul>
          <li onClick={toggleSidebar}>
            ...
            <Link to={T20WC24_BASE} className="custom-link">
              Home
            </Link>
          </li>
          <li onClick={toggleSidebar}>
            ...
            <Link to={`${T20WC24_BASE}/owners`} className="custom-link">
              Owner Page
            </Link>
          </li>
          <li onClick={toggleSidebar}>
            ...
            <Link to={`${T20WC24_BASE}/players`} className="custom-link">
              Player Page
            </Link>
          </li>
          <li onClick={toggleSidebar}>
            ...
            <Link to={`${T20WC24_BASE}/country`} className="custom-link">
              Country Lineup
            </Link>
          </li>
          <li onClick={toggleSidebar}>
            ...
            <Link to={`${T20WC24_BASE}/cvc`} className="custom-link">
              C/VC List
            </Link>
          </li>
          <li onClick={toggleSidebar}>
            ...
            <Link to={`${T20WC24_BASE}/past-results`} className="custom-link">
              Past Results
            </Link>
          </li>
          <li onClick={toggleSidebar}>
            ...
            <Link to={`${T20WC24_BASE}/predictions`} className="custom-link">
              Predictions
            </Link>
          </li>
        </ul>
